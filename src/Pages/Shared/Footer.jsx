...
const Footer = () => {
    ...
    return (
        <div className=" border-dashed border-lime-400 border-x-2 container mx-auto px-6 py-10 bg-slate-800">
        <div className="flex flex-col md:flex-row items-center justify-center mb-4">
         ...
         <div className="flex justify-center items-center space-x-6 my-6 md:mt-0">
           ...
           {/* Divider */}
        <hr className="my-6 border-lime-300 border-double border-2" />
...
<div className="flex flex-col md:flex-row items-center justify-between">
  ...
  <p className="text-gray-400 text-sm mt-4 md:mt-0">
    © 2025 Perfect Pair. All Rights Reserved.
  </p>
</div>
    </div>
    );
