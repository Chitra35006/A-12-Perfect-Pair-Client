...
const FavouriteBioData = () => {
  ...
  return (
    <div className="mt-10 mx-auto p-4 max-w-6xl">
        <Helmet><title>Perfect Pair || Favourite Page</title></Helmet>
        <h1 className="text-xl font-bold mb-4 text-indigo-900 border-double border-y-2 md:w-1/4 w-2/4 text-center border-lime-400 py-1">Favorite Data</h1>
      <Table
        columns={columns}
        dataSource={allFavData}
