    ...
    <div>
      ...
      >
        <div className="flex justify-center items-center">
          <h2
            className={`text-bold md:text-2xl ${
              theme === "dark" ? "text-lime-400" : "text-lime-600"
            } p-1 border-y-2 border-blue-300 px-2`}
          >
            Share Feelings to Us
          </h2>
        </div>
        <div
          className={`grid grid-cols-12 md:flex-col flex-row min-h-screen ${
            theme === "dark"
              ? "bg-[linear-gradient(25deg,#065f46_5%,_#1f2937_30%,_#1f2937_70%,_#3f6212_100%)]"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md">
              ...
              <div className="form-control w-full my-4">
                <TextField
                  ...
                  variant="outlined"
                  fullWidth
                  {...register("partnerBioId", {
                    required: "Partner Biodata Id is required",
                    validate: {
                      positiveNumber: (value) =>
                        value > 0 || "The number must be greater than 0",
                    },
                  })}
                  InputLabelProps={{
                    style: {
