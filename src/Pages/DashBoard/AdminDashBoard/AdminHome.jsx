  ...
  const cards = [
    ...
    return (
       <div>
        ...
        <h1 className="text-xl font-bold text-indigo-900 border-double border-y-2 mt-10 md:w-1/4 w-2/4 text-center border-lime-400 py-1 mx-auto mb-4">
        Dashboard
      </h1>
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
            ...
            {cards.map((card, index) => (
              ...
              >
                <div
                  className={`flex flex-col items-center justify-center p-6 rounded-lg bg-gradient-to-r ${card.gradient}`}
                >
